...
const EditTenagaKependidikanModal = ({ setIsOpenModalEdit, getGuru, selectedGuru }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.patch(`http://localhost:5000/tenaga/${selectedGuru.id}`, {
...
export default EditTenagaKependidikanModal;
