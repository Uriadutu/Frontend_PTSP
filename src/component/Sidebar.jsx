  ...
  return (
    <aside className="mt-7 w-[300px] fixed bg-white drop-shadow-xl overflow-y-scroll h-[90%]">
      <div className="mb-4 p-4 bg-gray-50 drop-shadow-xl">
        ...
        <h1 className="text-lg">Satker</h1>
      </div>
      <div className="mb-4">
        ...
        <nav>
          ...
          <div className="relative">
            ...
            {openDropdown === "lapasi" && (
              <div className="pl-6 transition-all duration-500 ease-out">
                ...
                <NavLink to="/lapasi/data-jabatan" className={getNavLinkClass}>
                  Data Jabatan
                </NavLink>
                <NavLink to="/lapasi/data-pegawai" className={getNavLinkClass}>
                  Data Pegawai
                </NavLink>
                <NavLink to="/lapasi/surat-masuk" className={getNavLinkClass}>
                  Data Surat Masuk
                </NavLink>
                <NavLink to="/lapasi/surat-keluar" className={getNavLinkClass}>
                  Data Surat Keluar
                </NavLink>
              </div>
            )}
          ...
          <div className="relative">
            ...
            {openDropdown === "akesahu" && (
              <div className="pl-6 transition-all duration-500 ease-out">
                ...
                <NavLink to="/akesahu/surat-masuk" className={getNavLinkClass}>
                  Data Surat Masuk
                </NavLink>
                <NavLink to="/akesahu/surat-keluar" className={getNavLinkClass}>
                  Data Surat Keluar
                </NavLink>
              </div>
            )}
          ...
          <div className="relative">
            ...
            {openDropdown === "paludi" && (
              <div className="pl-6 transition-all duration-500 ease-out">
                <NavLink to="/paludi/data-umat-kristen" className={getNavLinkClass}>
                  Data Umat
                </NavLink>
                <NavLink
                ...
                <NavLink to="/paludi/data-sekolah-paludi" className={getNavLinkClass}>
                  Data Sekolah
                </NavLink>
                <NavLink to="/paludi/data-guru-pak" className={getNavLinkClass}>
                  Data Guru PAK
                </NavLink>
                <NavLink to="/paludi/data-penyuluh" className={getNavLinkClass}>
                  Data Penyuluh
                </NavLink>
                <NavLink
          ...
          <div className="relative">
            ...
            {openDropdown === "sahu" && (
              <div className="pl-6 transition-all duration-500 ease-out">
                <NavLink to="/sahu/data-kecamatan" className={getNavLinkClass}>
                  Data Kecamatan
                </NavLink>
                <NavLink
          ...
          <button className="flex p-4 my-2 w-full">Logout</button>
        </nav>
      </div>
    </aside>
  );
